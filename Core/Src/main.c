...
int main(void)
{
  ...
  uint8_t data[] = {0xFF, 0x0}; // all

  /* Enable the DMA channel */
  HAL_DMA_Start( &hdma_tim2_up, (uint32_t)data, (uint32_t)&LED_GPIO_Port->ODR, 2 );
  ...
  {
	  //// <-- using Polling --> ////
	  if(__HAL_TIM_GET_COUNTER(&htim2) >= 500 ){	// max counter value is 1000
